    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php echo $active == 'laporan_konsumen' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('laporan_konsumen')?>"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Laporan Konsumen</span></a>
                </li>
                ...
                <li <?php echo $active == 'daftar_kriteria' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('daftar_kriteria')?>"><i class="fa fa-tasks"></i> <span class="nav-label">Kelola Kriteria</span></a>
                </li>
                <li <?php echo $active == 'topsis' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('topsis')?>"><i class="fa fa-area-chart"></i> <span class="nav-label">TOPSIS</span></a>
                </li>
                <li>
