...
<link href="<?php echo base_url('assets/beranda/plugins/font-awesome-4.7.0/css/font-awesome.min.css'); ?>" rel="stylesheet" type="text/css">
...
<div class="super_container">
	...
	<header class="header">
		<div class="header_inner d-flex flex-row align-items-center justify-content-start">
			...
			<nav class="main_nav">
				<ul>
					<li><a href="#">home</a></li>
					<li><a href="categories.html">Produk</a></li>
					<li><a href="categories.html">Profil</a></li>
					<li><a href="categories.html">Visi Misi</a></li>
					<li><a href="categories.html">Registrasi</a></li>
			...
			<div class="header_content ml-auto">
				...
				<div class="shopping">
					...
					<a href="#">
						<div class="cart">
							<img src="<?php echo base_url('assets/beranda/images/shopping-bag.svg'); ?>" alt="">
					...
					<a href="#">
						<div class="star">
							<img src="<?php echo base_url('assets/beranda/images/star.svg'); ?>" alt="">
		...
		<div class="container">
			...
			<div class="row promo_container">
				...
				<div class="col-lg-4 promo_col">
					<div class="promo_item">
						<div class="promo_image">
							<img src="<?php echo base_url('assets/beranda/images/promo_1.jpg'); ?>" alt="">
				...
				<div class="col-lg-4 promo_col">
					<div class="promo_item">
						<div class="promo_image">
							<img src="<?php echo base_url('assets/beranda/images/promo_2.jpg'); ?>" alt="">
				...
				<div class="col-lg-4 promo_col">
					<div class="promo_item">
						<div class="promo_image">
							<img src="<?php echo base_url('assets/beranda/images/promo_3.jpg'); ?>" alt="">
		...
		<div class="container">
			...
			<div class="row products_container">
				...
				<div class="col-lg-4 product_col">
					<div class="product">
						<div class="product_image">
							<img src="<?php echo base_url('assets/beranda/images/product_1.jpg'); ?>" alt="">
						</div>
				...
				<div class="col-lg-4 product_col">
					<div class="product">
						<div class="product_image">
							<img src="<?php echo base_url('assets/beranda/images/product_2.jpg'); ?>" alt="">
						</div>
						<div class="rating rating_4">
							<i class="fa fa-star"></i>
							<i class="fa fa-star"></i>
				...
				<div class="col-lg-4 product_col">
					<div class="product">
						<div class="product_image">
							<img src="<?php echo base_url('assets/beranda/images/product_3.jpg'); ?>" alt="">
						</div>
						<div class="rating rating_4">
							<i class="fa fa-star"></i>
							<i class="fa fa-star"></i>
	...
	<div class="extra clearfix">
		<div class="extra_promo extra_promo_1">
			<div class="extra_promo_image" style="background-image:url(<?php echo base_url('assets/beranda/images/extra_1.jpg'); ?>)"></div>
		...
		<div class="extra_promo extra_promo_2">
			<div class="extra_promo_image" style="background-image:url(<?php echo base_url('assets/beranda/images/extra_2.jpg'); ?>)"></div>
	...
	<div class="gallery">
		<div class="gallery_image" style="background-image:url(<?php echo base_url('assets/beranda/images/gallery.jpg'); ?>)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="owl-carousel owl-theme gallery_slider">
				...
				<div class="owl-item gallery_item">
					<a class="colorbox" href="images/gallery_1.jpg">
						<img src="<?php echo base_url('assets/beranda/images/gallery_1.jpg'); ?>" alt="">
					</a>
				</div>
				...
				<div class="owl-item gallery_item">
					<a class="colorbox" href="images/gallery_2.jpg">
						<img src="<?php echo base_url('assets/beranda/images/gallery_2.jpg'); ?>" alt="">
					</a>
				</div>
				...
				<div class="owl-item gallery_item">
					<a class="colorbox" href="images/gallery_3.jpg">
						<img src="<?php echo base_url('assets/beranda/images/gallery_3.jpg'); ?>" alt="">
					</a>
				</div>
				...
				<div class="owl-item gallery_item">
					<a class="colorbox" href="images/gallery_4.jpg">
						<img src="<?php echo base_url('assets/beranda/images/gallery_4.jpg'); ?>" alt="">
					</a>
				</div>
				...
				<div class="owl-item gallery_item">
					<a class="colorbox" href="images/gallery_5.jpg">
						<img src="<?php echo base_url('assets/beranda/images/gallery_5.jpg'); ?>" alt="">
					</a>
				</div>
				...
				<div class="owl-item gallery_item">
					<a class="colorbox" href="images/gallery_6.jpg">
						<img src="<?php echo base_url('assets/beranda/images/gallery_6.jpg'); ?>" alt="">
					</a>
				</div>
	...
	<div class="newsletter">
		<div class="newsletter_content">
			<div class="newsletter_image" style="background-image:url(<?php echo base_url('assets/beranda/images/newsletter.jpg'); ?>)"></div>
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="section_title_container text-center">
