        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php echo $active == 'daftar_transaksi' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('laporan_transaksi')?>"><i class="fa fa-book"></i> <span class="nav-label">Laporan Transaksi</span></a>
                </li>
                <li <?php echo $active == 'daftar_pembayaran' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('laporan_pembayaran')?>"><i class="fa fa-credit-card"></i> <span class="nav-label">Laporan Pembayaran</span></a>
                </li>
                <li <?php echo $active == 'daftar_komentar' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('laporan_komentar')?>"><i class="fa fa-comment"></i> <span class="nav-label">Laporan Komentar</span></a>
                </li>
                <li>
