        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo $this->session->userdata('nama_pembeli') ?></strong></span></span></a>
                    </div>
                ...
                <li <?php echo $active == 'daftar_transaksi' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('transaksi')?>"><i class="fa fa-book"></i> <span class="nav-label">Daftar Transaksi</span></a>
                </li>
                <li <?php echo $active == 'daftar_pembayaran' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('transaksi/daftar_pembayaran')?>"><i class="fa fa-credit-card"></i> <span class="nav-label">Daftar Pembayaran</span></a>
                </li>
                <li <?php echo $active == 'daftar_kendaraan' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('kendaraan')?>"><i class="fa fa-h-square"></i> <span class="nav-label">Daftar Kendaraan</span></a>
                </li>
                ...
                <li <?php echo $active == 'daftar_alamat' ? 'class="active"' : ''; ?>>
                    <a href="<?php echo site_url('daftar_alamat')?>"><i class="fa fa-road"></i> <span class="nav-label">Daftar Alamat</span></a>
                </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message">Selamat Datang, <?php echo $this->session->userdata('nama_pembeli') ?></span>
                        </li>
                        <li>
