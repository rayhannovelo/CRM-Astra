                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <label>Agama (Sesuai KTP) : </label><br>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label>Kelurahan berdasarkan KTP : </label>
                                        ...
                                        <div class="form-group">
                                            <label>Kecamatan berdasarkan KTP : </label>
                                        ...
                                        <div class="form-group">
                                            <label>Pengeluaran dalam 1 (satu) bulan (termasuk pengeluaran Keluarga) : </label><br>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <label>Apakah Anda bersedia dikirimkan Informasi terbaru program Honda ? </label>
                                                </div>
                                                <div class="col-md-5">
